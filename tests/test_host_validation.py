...
def test_valid_us_cloud():
    assert (
        validate_langfuse_host("https://us.cloud.langfuse.com") == "https://us.cloud.langfuse.com"
    )


def test_valid_eu_cloud():
    assert (
        validate_langfuse_host("https://eu.cloud.langfuse.com") == "https://eu.cloud.langfuse.com"
    )


def test_valid_subdomain_of_allowed():
    assert (
        validate_langfuse_host("https://selfhosted.cloud.langfuse.com")
        == "https://selfhosted.cloud.langfuse.com"
    )
